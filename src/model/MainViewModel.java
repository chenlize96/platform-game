...
/**
 * View Model which contains information how many health left and the coordinate
 * of exit, starting position of character
 * 
 * @author Eujin Ko
 * @author Lize Chen
 *
...
public class MainViewModel {
	...
	public void movingBoxPopAndAddToStack(String direction, int[] coordinate) {
		// System.out.println("BOX(remove+model)= "+movingBoxes.remove(coordinate)+" =
		// "+direction+" = "+Arrays.toString(coordinate) );
