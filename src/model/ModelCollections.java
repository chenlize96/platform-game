...
public class ModelCollections extends Observable {
	...
	/**
	 * Constructor for ModelCollections, saves controllerCollections for further use
	 * inside the class
	 * 
	...
	public void tick() {
		...
		// "+box_direction+":"+Arrays.toString(box_coordinate));
		...
		CollectionsMessage msg = new CollectionsMessage(char_msg, health_status, win, keyPos, ifPortal, box_direction,
				box_coordinate);
		setChanged();
		notifyObservers(msg);
