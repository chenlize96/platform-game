...
public class PuzzlePlatformerView extends Application implements Observer {
    ...
    private Rectangle wall1 = new Rectangle(20, 5, Color.ROSYBROWN); //radius = 10
    private Rectangle wall2 = new Rectangle(20, 5, Color.ROSYBROWN); //radius = 10
    private Rectangle wall3 = new Rectangle(5, 20, Color.ROSYBROWN); //radius = 10
    private Rectangle wall4 = new Rectangle(5, 20, Color.ROSYBROWN); //radius = 10
...
//        System.out.println(character_controller.getPlayerPosition().getdx() + ""  + character_controller.getPlayerPosition().getdy());
        if (RIGHT) {
            moveX = MOVE_SIZE;
        }
        if (LEFT) {
...
//	    path.getElements().add(new LineTo(curX+character_size[0]/2, curY+unit_size));
        ...
        DenseFogModel.set(prevX, curX, prevY, curY, wall3, wall2,
                wall1, wall4);
